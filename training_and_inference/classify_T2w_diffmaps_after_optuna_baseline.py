...
from training_and_inference.utils_volume_classification import extract_volumes_and_labels,\
    ...
    set_parameter_requires_grad, extract_validation_data, select_model, run_inference, create_dir_if_not_exist
...
def classification_t2_volumes_difference_after_optuna_baseline(df_dates_and_labels_had: str,
                                                               input_dir: str,
                                                               batch_size: int,
                                                               nb_workers: int,
                                                               ext_cv_folds: int,
...
def main():
    ...
    study_name = study_name.replace("foldX", "fold{}".format(str(fold_to_do)))
